...
- Local workspace: a separately installed `mi_fitness_data_bridge` checkout
- Current bridge license: AGPL-3.0-only (upstream MIT attribution is retained in the bridge notices)
