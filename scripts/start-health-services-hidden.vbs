...
' Task: HealthAssistant. Hidden launcher (window style 0) + result capture (P0 upgrade 2026-07-25).
' Writes D:\AIWorkspace\workspace_admin\state\task-results\HealthAssistant.json and exits with the wrapped command's exit code.
Option Explicit
...
json = "{" & Q & "task" & Q & ":" & Q & "HealthAssistant" & Q & "," & Q & "finished_at" & Q & ":" & Q & ts & Q & "," & Q & "exit_code" & Q & ":" & exitCode & "," & Q & "async_launch" & Q & ":" & LCase(CStr(ASYNC_LAUNCH = 1)) & "," & Q & "console_log" & Q & ":" & Q & Replace(logFile, "\", "\\") & Q & "," & Q & "console_bytes" & Q & ":" & logSize & "," & Q & "suspicious_zero_output" & Q & ":" & suspicious & "}"
